...
public class LibrarianLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Library Manager Login");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(M.getPass().equals(jPasswordField1.getText())  &&  M.getUsername().equals(jTextField1.getText())) {
            new LibraryManagment(a).setVisible(true);
