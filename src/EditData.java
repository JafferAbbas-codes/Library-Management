...
public class EditData extends javax.swing.JFrame {
    ...
    boolean name, author, serial, type;

    public EditData(Catalogue k, boolean s, boolean b, boolean c, boolean d,AccountsSettings ac) {
        ...
        type = d;
        this.acc = ac;
        jTextField2.setSize(169, 25);
        jTextField3.setSize(169, 25);
        jTextField4.setSize(169, 25);
        jTextField5.setSize(169, 25);
        jLabel2.show(s);
        jLabel3.show(b);
        jLabel4.show(c);
        jLabel5.show(d);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(760, 1300));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/if_ok_46824.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/if_cancel_46786.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (a.search(x)) {
                if (name) {
                    a.b.setname(jTextField2.getText());
                }
                if (serial) {
                    a.b.setserial(jTextField3.getText());
               }
                if (author) {
                    a.b.setauthor(jTextField4.getText());
               }
                if (type) {
                    a.b.settype(jTextField5.getText());
                }
                a.replace();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        new Edit(a,acc).setVisible(true);
